...
var Parse = {
  ...
  create: function(message, successCB, errorCB = null) {
    // TODO: unclear if this is correct, it's just pattern matched right now
    ...
    $.ajax({
      ...
      error: errorCB || function(data) {
        console.error('chatterbox: Failed to post messages', data);
      }
    });
  },
  ...
  readAll: function(successCB, errorCB = null) {
    $.ajax({
      url: Parse.server,
      type: 'GET',
      data: ({ order: '-createdAt' }), // reverted back to original, no conflict
      contentType: 'application/json',
      success: successCB,
